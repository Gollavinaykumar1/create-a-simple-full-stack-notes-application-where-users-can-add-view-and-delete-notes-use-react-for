// src/App.jsx — Generated by VIA for: Create a simple full-stack Notes application where users can add, view, and delete notes. Use React for the frontend, Node.js and Express for the backend, and MongoDB for the database. Keep the UI simple and clean. Include API integration and basic project structure.
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Create A Simple Full Stack Notes Application Where</span>
            </Link>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Create A Simple Full Stack Notes Application Where</h1>
